...
function deposit(message, userData) {
    ...
    if (amount > spaceLeft) {
        //@ts-ignore
        return message.channel.send(`Your bank can only hold **${spaceLeft}** more coins (capacity: ${maxBank}).`);
    }
    // Apply deposit
    user.balance -= amount;
    ...
    //@ts-ignore
    return message.channel.send(`💰 Deposited **${amount}** coins.\n` +
