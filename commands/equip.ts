...
export function equip(Message: Message, userData: any) {
  ...
  // ===========================================
  const itemMatch = Object.values(ITEMS).find(
...
if (item.type === "armor") {
  ...
  return Message.channel.send(
    `🛡️ Equipped **${item.name}** to **${slot}** slot!`
  );
}
