...
//@ts-ignore
async function exchange(message, userData) {
    ...
    const endpoint = `http://home.seceurity.place:8222/api/give-money/${message.author.id}/${converted}?key=${API_KEY}`;
    try {
        ...
        return message.channel.send(`💱 Exchanged **${amount}** coins.\n` +
